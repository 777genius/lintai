...
- no Homebrew, npm, or `cargo install` CLI distribution promise in this release
- no package-manager install contract; the curl path resolves to the GitHub Release installer asset
