...
- preserve extension wave history via archived wave baselines
...
- docs/spec/schema/contracts-only path segments are excluded via tokenized path normalization, including forms like `ToolSchemas`, `tool-schemas`, and `schema_store`
