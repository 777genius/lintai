import { defineComponent, ref, computed, watchEffect, mergeProps, withCtx, unref, createVNode, toDisplayString, openBlock, createBlock, createTextVNode, Fragment, createCommentVNode, renderList, useSSRContext } from 'file:///Users/belief/dev/projects/lintai/landing/node_modules/.pnpm/vue@3.5.31_typescript@6.0.2/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderAttr, ssrRenderList, ssrRenderClass, ssrRenderStyle } from 'file:///Users/belief/dev/projects/lintai/landing/node_modules/.pnpm/vue@3.5.31_typescript@6.0.2/node_modules/vue/server-renderer/index.mjs';
import { a as useLandingContent, b as useReleaseDownloads, f as formatReleaseDate } from './usePageSeo-Ba4JSXZC.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const releaseDate = computed(() => {
      var _a;
      if (!((_a = releaseData.value) == null ? void 0 : _a.pubDate)) {
        return "";
      }
    ...
    watchEffect(() => {
      ...
      selectedInstallId.value = ((_a = quickstartInstallChannels.value.find((channel) => channel.recommended)) == null ? void 0 : _a.id) || ((_b = quickstartInstallChannels.value[0]) == null ? void 0 : _b.id) || null;
    });
    ...
    const quickstartSteps = computed(
      () => content.value.quickstartSteps.map((step) => {
        var _a;
        if (step.id !== "install" || !((_a = selectedInstallChannel.value) == null ? void 0 : _a.command)) {
          return step;
        }
        return {
          ...step,
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (unref(releaseVersion)) {
              _push2(`<p class="download-section__release-info" data-v-232bd77c${_scopeId}>${ssrInterpolate(unref(t)("download.latestRelease"))} \xB7 <a${ssrRenderAttr("href", unref(fallbackUrl))} target="_blank" rel="noopener noreferrer" data-v-232bd77c${_scopeId}>v${ssrInterpolate(unref(releaseVersion))}</a>`);
              if (unref(releaseDate)) {
                _push2(`<!--[--> \xB7 ${ssrInterpolate(unref(releaseDate))}<!--]-->`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</p>`);
            ...
            return [
              createVNode("div", { class: "download-section__header" }, [
                ...
                unref(releaseVersion) ? (openBlock(), createBlock("p", {
                  ...
                  createTextVNode(toDisplayString(unref(t)("download.latestRelease")) + " \xB7 ", 1),
                  createVNode("a", {
...
//# sourceMappingURL=DownloadSection-BF4_R9cX.mjs.map
