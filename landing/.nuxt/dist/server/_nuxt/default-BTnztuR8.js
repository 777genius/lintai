import { defineComponent, shallowRef, h, resolveComponent, computed, unref, capitalize, camelize, mergeProps, withCtx, createVNode, useSSRContext, createElementVNode, normalizeStyle, normalizeClass, TransitionGroup, Transition, ref, watch, nextTick, toRef, withDirectives, Fragment, vShow, useId, provide, onScopeDispose, inject, toDisplayString, toRaw, toValue, readonly, watchEffect, reactive, Teleport, cloneVNode, createTextVNode, isRef, openBlock, createBlock, renderList, createCommentVNode, withKeys, vModelText, withModifiers, renderSlot } from "vue";
import { n as useRouter, o as parseQuery, q as encodeRoutePath, r as hasProtocol, s as resolveRouteObject, v as joinURL, w as navigateTo, f as useNuxtApp, e as useRuntimeConfig, x as withTrailingSlash, y as withoutTrailingSlash, z as nuxtLinkDefaults, g as genericComponent, a as makeComponentProps, A as useLocalePath, _ as _export_sfc, B as useDimension, C as useRender, p as propsFactory, D as makeDimensionProps, E as isObject, F as onlyDefinedProps, G as useBackgroundColor, H as useRounded, I as getCurrentInstance, J as convertToUnit, K as makeRoundedProps, L as provideTheme, M as useBorder, N as useVariant, O as useDensity, P as useSize, d as VIcon, Q as VDefaultsProvider, R as genOverlays, S as IconValue, T as makeVariantProps, U as makeThemeProps, m as makeTagProps, W as makeSizeProps, X as makeDensityProps, Y as makeBorderProps, Z as EventProp, $ as deepEqual, a0 as useProxiedModel, a1 as provideDefaults, a2 as Ripple, a3 as filterInputAttrs, a4 as wrapInArray, a5 as useTextColor, a6 as matchesSelector, a7 as omit, a8 as useLocale, a9 as callEvent, aa as acceleratedEasing, ab as standardEasing, ac as deceleratedEasing, ad as getCurrentInstanceName, ae as useToggleScope, af as useRtl, ag as pick, ah as makeGroupProps, ai as makeDisplayProps, aj as useDisplay, ak as useGroup, al as useResizeObserver, am as useGoTo, an as focusableChildren, ao as useElevation, ap as useGroupItem, aq as useLink, ar as makeRouterProps, as as makeGroupItemProps, at as makeElevationProps, au as consoleError, av as defineComponent$1, aw as deprecate, ax as isPrimitive, ay as getPropertyFromItem, az as focusChild, aA as destructComputed, aB as parseAnchor, aC as flipSide, aD as flipAlign, aE as flipCorner, aF as CircularBuffer, aG as getAxis, aH as clamp, aI as defer, aJ as templateRef, aK as useRouter$1, aL as isClickInsideElement, aM as getNextElement, aN as useLocation, aO as usePosition, aP as makePositionProps, aQ as makeLocationProps, aR as useLoader, aS as LoaderSlot, aT as makeLoaderProps, aU as debounce, aV as camelizeProps, aW as ensureValidVNode, aX as checkPrintable, aY as noop, u as useI18n, k as useSwitchLocalePath, c as VBtn, j as useRoute, V as VContainer, aZ as VApp } from "../server.mjs";
import "/Users/belief/dev/projects/lintai/landing/node_modules/.pnpm/defu@6.1.6/node_modules/defu/dist/defu.mjs";
import { ssrRenderComponent, ssrRenderAttr, ssrRenderList, ssrInterpolate, ssrRenderAttrs, ssrRenderTeleport, ssrRenderStyle, ssrRenderSlot } from "vue/server-renderer";
import __nuxt_component_0$3 from "./Icon-D1LAQcan.js";
import { s as supportedLocales, u as useDocsLinks } from "./i18n-B_nLlkZy.js";
import { defineStore } from "pinia";
import { V as VSlideYTransition, a as VFadeTransition, b as VExpandXTransition, c as VExpandTransition, u as useLazy, m as makeLazyProps, d as useAnalytics } from "./lazy-CNBWeTG7.js";
import { mdiWeatherSunny, mdiWeatherNight, mdiGithub, mdiMenu, mdiClose } from "@mdi/js";
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const currentFlagIcon = computed(() => {
      return flagIconMap[locale.value] ?? "circle-flags:xx";
    });
          ...
          if (_push2) {
            ...
            return [
              createVNode("span", { class: "app-footer__copy" }, [
                ...
                createTextVNode(" · " + toDisplayString(unref(t)("footer.tagline")), 1)
              ]),
...
//# sourceMappingURL=default-BTnztuR8.js.map
