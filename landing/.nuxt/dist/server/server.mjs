...
import { hasInjectionContext, getCurrentInstance as getCurrentInstance$2, shallowReactive, reactive, effectScope, getCurrentScope, inject as inject$1, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineComponent as defineComponent$1, createElementBlock, provide, cloneVNode, h, ref, unref, computed, Fragment, createVNode, Text, defineAsyncComponent, warn as warn$1, watchEffect, capitalize as capitalize$1, isVNode as isVNode$2, Comment, camelize, toValue, normalizeClass, mergeProps, createElementVNode, watch, onScopeDispose, toRefs, readonly, Suspense, nextTick, withCtx, useSSRContext, normalizeStyle, useId, Transition, resolveDynamicComponent, withDirectives, toDisplayString as toDisplayString$1, createTextVNode, onErrorCaptured, onServerPrefetch, createApp } from "vue";
import { $fetch as $fetch$1 } from "/Users/belief/dev/projects/lintai/landing/node_modules/.pnpm/ofetch@1.5.1/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/Users/belief/dev/projects/lintai/landing/node_modules/.pnpm/hookable@5.5.3/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/Users/belief/dev/projects/lintai/landing/node_modules/.pnpm/unctx@2.5.0/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, appendHeader, getRequestHeaders, getRequestHeader, setCookie, getCookie, deleteCookie, getRequestProtocol } from "/Users/belief/dev/projects/lintai/landing/node_modules/.pnpm/h3@1.15.11/node_modules/h3/dist/index.mjs";
import { shouldHydrate, setActivePinia, createPinia } from "pinia";
import { defu } from "/Users/belief/dev/projects/lintai/landing/node_modules/.pnpm/defu@6.1.6/node_modules/defu/dist/defu.mjs";
...
import { parse as parse$1 } from "/Users/belief/dev/projects/lintai/landing/node_modules/.pnpm/cookie-es@2.0.1/node_modules/cookie-es/dist/index.mjs";
import destr from "/Users/belief/dev/projects/lintai/landing/node_modules/.pnpm/destr@2.0.5/node_modules/destr/dist/index.mjs";
import { isEqual as isEqual$2 } from "/Users/belief/dev/projects/lintai/landing/node_modules/.pnpm/ohash@2.0.11/node_modules/ohash/dist/index.mjs";
...
const _routes = [
  {
    name: "index___en",
    path: "/",
    component: () => import("./_nuxt/index-DlBCAopn.js").then((n) => n.i)
  },
  {
    name: "index___ru",
    path: "/ru",
  ...
  },
  {
    name: "download___en",
    path: "/download",
    component: () => import("./_nuxt/download-BPC7ENgR.js")
  },
  {
    name: "download___ru",
    path: "/ru/download",
...
function createCompileError(code, loc, options = {}) {
  ...
  const msg = process.env.NODE_ENV !== "production" ? format$2((messages || errorMessages$3)[code] || "", ...args || []) : code;
...
function createCoreError(code) {
  return createCompileError(code, null, process.env.NODE_ENV !== "production" ? { messages: errorMessages$2 } : void 0);
}
...
function createI18nError$1(code, ...args) {
  return createCompileError(code, null, process.env.NODE_ENV !== "production" ? { messages: errorMessages$1, args } : void 0);
}
    ...
    if (!key.includes(".")) {
      ...
      for (let i = 0; i < lastIndex; i++) {
        ...
        if (!isObject$1(currentObj[subKeys[i]])) {
          process.env.NODE_ENV !== "production" && warn(getWarnMessage$1(I18nWarnCodes$1.IGNORE_OBJ_FLATTEN, {
            key: subKeys[i]
          }));
          hasStringValue = true;
          break;
...
const LazyIcon = defineAsyncComponent(() => import("./_nuxt/Icon-D1LAQcan.js").then((r) => r["default"] || r.default || r));
const LazyIconCSS = defineAsyncComponent(() => import("./_nuxt/IconCSS-DpZ5SiEn.js").then((r) => r["default"] || r.default || r));
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-BTnztuR8.js").then((m) => m.default || m))
};
...
export {
  ...
  isObject as E,
  onlyDefinedProps as F,
  useBackgroundColor as G,
  useRounded as H,
  getCurrentInstance$1 as I,
  convertToUnit as J,
  ...
  EventProp as Z,
  _export_sfc as _,
  makeComponentProps as a,
  useProxiedModel as a0,
  provideDefaults as a1,
  Ripple as a2,
  filterInputAttrs as a3,
  wrapInArray as a4,
  useTextColor as a5,
  ...
  getNextElement as aM,
  useLocation as aN,
  usePosition as aO,
  makePositionProps as aP,
  makeLocationProps as aQ,
  useLoader as aR,
  LoaderSlot as aS,
  makeLoaderProps as aT,
  debounce as aU,
  camelizeProps as aV,
  ensureValidVNode as aW,
  checkPrintable as aX,
  noop as aY,
  VApp as aZ,
  PREFERS_REDUCED_MOTION as a_,
  acceleratedEasing as aa,
  standardEasing as ab,
  deceleratedEasing as ac,
  getCurrentInstanceName as ad,
  useToggleScope as ae,
  useRtl as af,
  pick as ag,
  makeGroupProps as ah,
  makeDisplayProps as ai,
  useDisplay as aj,
  useGroup as ak,
  ...
  makeGroupItemProps as as,
  makeElevationProps as at,
  consoleError as au,
  ...
  parseQuery as o,
  propsFactory as p,
  encodeRoutePath as q,
  hasProtocol as r,
  resolveRouteObject$1 as s,
  tryUseNuxtApp as t,
  useI18n as u,
  joinURL as v,
  navigateTo as w,
