...
use crate::claude_settings_rules::{
    ...
    check_claude_settings_git_add_permission, check_claude_settings_git_checkout_permission,
    check_claude_settings_git_clone_permission, check_claude_settings_git_commit_permission,
    check_claude_settings_git_branch_permission, check_claude_settings_git_config_permission,
    ...
    check_claude_settings_wget_permission, check_claude_settings_write_wildcard,
};
...
pub(crate) const RULE_SPECS: [NativeRuleSpec; 38] = [
    ...
    NativeRuleSpec {
        ...
        detection_class: DetectionClass::Structural,
        lifecycle: RuleLifecycle::Preview {
            blocker: "Shared `Bash(curl:*)` permissions in committed Claude settings are deterministic, but the first release stays guidance-only while ecosystem usefulness is measured.",
            promotion_requirements: STRUCTURAL_PREVIEW_REQUIREMENTS,
        },
    ...
    NativeRuleSpec {
        ...
        detection_class: DetectionClass::Structural,
        lifecycle: RuleLifecycle::Preview {
            blocker: "Shared `Bash(wget:*)` permissions in committed Claude settings are deterministic, but the first release stays guidance-only while ecosystem usefulness is measured.",
            promotion_requirements: STRUCTURAL_PREVIEW_REQUIREMENTS,
        },
    ...
    NativeRuleSpec {
        ...
        detection_class: DetectionClass::Structural,
        lifecycle: RuleLifecycle::Preview {
            blocker: "Shared `git config` permissions in committed Claude settings are deterministic, but the first release stays guidance-only until ecosystem usefulness is measured.",
            promotion_requirements: STRUCTURAL_PREVIEW_REQUIREMENTS,
        },
    ...
    NativeRuleSpec {
        ...
        detection_class: DetectionClass::Structural,
        lifecycle: RuleLifecycle::Preview {
            blocker: "Shared `git branch` permissions in committed Claude settings are deterministic, but the first release stays guidance-only until ecosystem usefulness is measured.",
            promotion_requirements: STRUCTURAL_PREVIEW_REQUIREMENTS,
        },
