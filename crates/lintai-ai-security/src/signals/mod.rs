...
pub(crate) struct MarkdownSignals {
    ...
    pub(crate) pip_config_http_index_spans: Vec<Span>,
    pub(crate) pip_config_http_find_links_spans: Vec<Span>,
    pub(crate) pip_config_trusted_host_spans: Vec<Span>,
    pub(crate) network_tls_bypass_spans: Vec<Span>,
    pub(crate) pip_http_source_spans: Vec<Span>,
    pub(crate) npm_http_registry_spans: Vec<Span>,
    pub(crate) js_package_config_http_registry_spans: Vec<Span>,
    pub(crate) js_package_strict_ssl_false_spans: Vec<Span>,
    ...
    pub(crate) git_checkout_allowed_tools_spans: Vec<Span>,
    ...
    pub(crate) gh_api_post_allowed_tools_spans: Vec<Span>,
    pub(crate) gh_api_delete_allowed_tools_spans: Vec<Span>,
    pub(crate) gh_api_patch_allowed_tools_spans: Vec<Span>,
    pub(crate) gh_api_put_allowed_tools_spans: Vec<Span>,
    pub(crate) gh_issue_create_allowed_tools_spans: Vec<Span>,
    pub(crate) gh_repo_create_allowed_tools_spans: Vec<Span>,
    pub(crate) gh_repo_delete_allowed_tools_spans: Vec<Span>,
    pub(crate) gh_repo_edit_allowed_tools_spans: Vec<Span>,
    pub(crate) gh_repo_transfer_allowed_tools_spans: Vec<Span>,
    pub(crate) gh_release_create_allowed_tools_spans: Vec<Span>,
    pub(crate) gh_release_delete_allowed_tools_spans: Vec<Span>,
    pub(crate) gh_release_upload_allowed_tools_spans: Vec<Span>,
    pub(crate) gh_secret_set_allowed_tools_spans: Vec<Span>,
    pub(crate) gh_variable_set_allowed_tools_spans: Vec<Span>,
    pub(crate) gh_workflow_run_allowed_tools_spans: Vec<Span>,
    pub(crate) gh_secret_delete_allowed_tools_spans: Vec<Span>,
    pub(crate) gh_variable_delete_allowed_tools_spans: Vec<Span>,
    pub(crate) gh_workflow_disable_allowed_tools_spans: Vec<Span>,
    pub(crate) npm_exec_allowed_tools_spans: Vec<Span>,
    pub(crate) bunx_allowed_tools_spans: Vec<Span>,
    pub(crate) uvx_allowed_tools_spans: Vec<Span>,
    ...
    pub(crate) rm_allowed_tools_spans: Vec<Span>,
    pub(crate) chmod_allowed_tools_spans: Vec<Span>,
    pub(crate) chown_allowed_tools_spans: Vec<Span>,
    pub(crate) chgrp_allowed_tools_spans: Vec<Span>,
    pub(crate) su_allowed_tools_spans: Vec<Span>,
    pub(crate) git_clone_allowed_tools_spans: Vec<Span>,
    pub(crate) git_add_allowed_tools_spans: Vec<Span>,
    pub(crate) git_fetch_allowed_tools_spans: Vec<Span>,
    pub(crate) webfetch_raw_github_allowed_tools_spans: Vec<Span>,
    ...
    pub(crate) git_restore_allowed_tools_spans: Vec<Span>,
    pub(crate) git_rebase_allowed_tools_spans: Vec<Span>,
    pub(crate) git_merge_allowed_tools_spans: Vec<Span>,
    pub(crate) git_cherry_pick_allowed_tools_spans: Vec<Span>,
    pub(crate) git_apply_allowed_tools_spans: Vec<Span>,
    pub(crate) git_am_allowed_tools_spans: Vec<Span>,
    pub(crate) package_install_allowed_tools_spans: Vec<Span>,
    ...
    pub(crate) wildcard_read_allowed_tools_spans: Vec<Span>,
    pub(crate) wildcard_write_allowed_tools_spans: Vec<Span>,
    pub(crate) wildcard_edit_allowed_tools_spans: Vec<Span>,
    pub(crate) wildcard_glob_allowed_tools_spans: Vec<Span>,
    pub(crate) wildcard_grep_allowed_tools_spans: Vec<Span>,
    pub(crate) wildcard_webfetch_allowed_tools_spans: Vec<Span>,
    pub(crate) wildcard_websearch_allowed_tools_spans: Vec<Span>,
    pub(crate) read_unsafe_path_allowed_tools_spans: Vec<Span>,
    pub(crate) write_unsafe_path_allowed_tools_spans: Vec<Span>,
    pub(crate) edit_unsafe_path_allowed_tools_spans: Vec<Span>,
    pub(crate) glob_unsafe_path_allowed_tools_spans: Vec<Span>,
...
pub(crate) struct JsonSignals {
    ...
    pub(crate) autoapprove_bash_wildcard_span: Option<Span>,
    pub(crate) autoapprove_curl_span: Option<Span>,
    pub(crate) autoapprove_wget_span: Option<Span>,
    pub(crate) autoapprove_sudo_span: Option<Span>,
    pub(crate) autoapprove_rm_span: Option<Span>,
    pub(crate) autoapprove_git_push_span: Option<Span>,
    pub(crate) autoapprove_gh_api_post_span: Option<Span>,
    pub(crate) autoapprove_git_checkout_span: Option<Span>,
    pub(crate) autoapprove_git_commit_span: Option<Span>,
    pub(crate) autoapprove_git_reset_span: Option<Span>,
    pub(crate) autoapprove_git_clean_span: Option<Span>,
    pub(crate) autoapprove_gh_api_delete_span: Option<Span>,
    pub(crate) autoapprove_gh_api_patch_span: Option<Span>,
    pub(crate) autoapprove_gh_api_put_span: Option<Span>,
    pub(crate) autoapprove_gh_issue_create_span: Option<Span>,
    pub(crate) autoapprove_gh_repo_create_span: Option<Span>,
    pub(crate) autoapprove_gh_repo_delete_span: Option<Span>,
    pub(crate) autoapprove_gh_repo_edit_span: Option<Span>,
    pub(crate) autoapprove_gh_secret_set_span: Option<Span>,
    pub(crate) autoapprove_gh_variable_set_span: Option<Span>,
    pub(crate) autoapprove_gh_workflow_run_span: Option<Span>,
    pub(crate) autoapprove_gh_secret_delete_span: Option<Span>,
    pub(crate) autoapprove_gh_variable_delete_span: Option<Span>,
    pub(crate) autoapprove_gh_workflow_disable_span: Option<Span>,
    pub(crate) autoapprove_gh_repo_transfer_span: Option<Span>,
    pub(crate) autoapprove_gh_release_create_span: Option<Span>,
    pub(crate) autoapprove_gh_release_delete_span: Option<Span>,
    pub(crate) autoapprove_gh_release_upload_span: Option<Span>,
    pub(crate) autoapprove_npx_span: Option<Span>,
    pub(crate) autoapprove_uvx_span: Option<Span>,
    pub(crate) autoapprove_npm_exec_span: Option<Span>,
    pub(crate) autoapprove_bunx_span: Option<Span>,
    ...
    pub(crate) autoapprove_git_add_span: Option<Span>,
    pub(crate) autoapprove_git_config_span: Option<Span>,
    pub(crate) autoapprove_git_tag_span: Option<Span>,
    pub(crate) autoapprove_git_branch_span: Option<Span>,
    pub(crate) autoapprove_git_stash_span: Option<Span>,
    pub(crate) autoapprove_git_restore_span: Option<Span>,
    pub(crate) autoapprove_git_rebase_span: Option<Span>,
    pub(crate) autoapprove_git_merge_span: Option<Span>,
    pub(crate) autoapprove_git_cherry_pick_span: Option<Span>,
    pub(crate) autoapprove_git_apply_span: Option<Span>,
    pub(crate) autoapprove_git_am_span: Option<Span>,
    pub(crate) autoapprove_gh_pr_span: Option<Span>,
    pub(crate) autoapprove_crontab_span: Option<Span>,
    pub(crate) autoapprove_systemctl_enable_span: Option<Span>,
    pub(crate) autoapprove_launchctl_load_span: Option<Span>,
    pub(crate) autoapprove_launchctl_bootstrap_span: Option<Span>,
    pub(crate) autoapprove_chmod_span: Option<Span>,
    ...
    pub(crate) autoapprove_glob_unscoped_span: Option<Span>,
    pub(crate) autoapprove_grep_unscoped_span: Option<Span>,
    pub(crate) autoapprove_webfetch_unscoped_span: Option<Span>,
    pub(crate) autoapprove_websearch_unscoped_span: Option<Span>,
    ...
    pub(crate) autoapprove_edit_unsafe_path_span: Option<Span>,
    pub(crate) autoapprove_glob_unsafe_path_span: Option<Span>,
    pub(crate) autoapprove_grep_unsafe_path_span: Option<Span>,
...
pub(crate) struct ClaudeSettingsSignals {
    ...
    pub(crate) unscoped_read_span: Option<Span>,
    pub(crate) unscoped_write_span: Option<Span>,
    pub(crate) unscoped_edit_span: Option<Span>,
    pub(crate) unscoped_glob_span: Option<Span>,
    pub(crate) unscoped_grep_span: Option<Span>,
    pub(crate) unscoped_webfetch_span: Option<Span>,
    ...
    pub(crate) gh_api_post_permission_span: Option<Span>,
    pub(crate) gh_api_delete_permission_span: Option<Span>,
    pub(crate) gh_api_patch_permission_span: Option<Span>,
    pub(crate) gh_api_put_permission_span: Option<Span>,
    pub(crate) gh_issue_create_permission_span: Option<Span>,
    pub(crate) gh_repo_create_permission_span: Option<Span>,
    pub(crate) gh_repo_delete_permission_span: Option<Span>,
    pub(crate) gh_repo_edit_permission_span: Option<Span>,
    pub(crate) gh_repo_transfer_permission_span: Option<Span>,
    pub(crate) gh_release_create_permission_span: Option<Span>,
    pub(crate) gh_release_delete_permission_span: Option<Span>,
    pub(crate) gh_release_upload_permission_span: Option<Span>,
    pub(crate) gh_secret_set_permission_span: Option<Span>,
    pub(crate) gh_variable_set_permission_span: Option<Span>,
    pub(crate) gh_workflow_run_permission_span: Option<Span>,
    pub(crate) gh_secret_delete_permission_span: Option<Span>,
    pub(crate) gh_variable_delete_permission_span: Option<Span>,
    pub(crate) gh_workflow_disable_permission_span: Option<Span>,
    ...
    pub(crate) git_branch_permission_span: Option<Span>,
    ...
    pub(crate) git_reset_permission_span: Option<Span>,
    pub(crate) git_clean_permission_span: Option<Span>,
    pub(crate) git_restore_permission_span: Option<Span>,
    pub(crate) git_rebase_permission_span: Option<Span>,
    pub(crate) git_merge_permission_span: Option<Span>,
    pub(crate) git_cherry_pick_permission_span: Option<Span>,
    pub(crate) git_apply_permission_span: Option<Span>,
    pub(crate) git_am_permission_span: Option<Span>,
