...
impl ClaudeSettingsSignals {
    pub(super) fn from_context(ctx: &ScanContext, metrics: &mut SignalWorkBudget) -> Option<Self> {
        ...
        signals.gh_api_patch_permission_span = resolve_permissions_allow_exact_span(
            value,
            locator_ref.as_ref(),
            "Bash(gh api --method PATCH:*)",
        );
        signals.gh_api_put_permission_span = resolve_permissions_allow_exact_span(
            value,
            locator_ref.as_ref(),
        ...
        signals.gh_repo_edit_permission_span = resolve_permissions_allow_exact_span(
            value,
            locator_ref.as_ref(),
            "Bash(gh repo edit:*)",
        );
        signals.gh_repo_transfer_permission_span = resolve_permissions_allow_exact_span(
            value,
            locator_ref.as_ref(),
            "Bash(gh repo transfer:*)",
        );
        signals.gh_release_create_permission_span = resolve_permissions_allow_exact_span(
            value,
            locator_ref.as_ref(),
        ...
        signals.gh_release_upload_permission_span = resolve_permissions_allow_exact_span(
            value,
            locator_ref.as_ref(),
