...
pub(crate) fn is_github_copilot_instruction_path(normalized_path: &str) -> bool {
    normalized_path == ".github/copilot-instructions.md"
        || is_github_copilot_path_specific_instruction_path(normalized_path)
}

pub(crate) fn is_github_copilot_path_specific_instruction_path(normalized_path: &str) -> bool {
