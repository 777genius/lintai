...
fn known_rule_tier(rule_code: &str) -> Option<RuleTier> {
    match rule_code {
        ...
        | "SEC394" | "SEC395" | "SEC396" | "SEC397" | "SEC398" => Some(RuleTier::Stable),
        ...
        | "SEC399" | "SEC400" | "SEC405" | "SEC411" | "SEC412" | "SEC413" | "SEC414" | "SEC415"
        | "SEC416" | "SEC417" | "SEC401" | "SEC402" | "SEC403" => Some(RuleTier::Preview),
        _ => None,
    }
}
